...
namespace DBMIDPROJECT
{
    public class PDFgenerate
    {
        public static void GeneratePdf(DataTable dataTable, string titlePdf)
        {
            ...
            document.Info.Author = "Alishba Mazhar";
            ...
            XColor titleColor = XColors.RosyBrown;
            ...
            DrawCenteredText(gfx, "PDF developed by Alishba", contentFont, XColors.Black, page.Width, marginTop + 30);
